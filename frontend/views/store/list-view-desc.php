            ...
            <div class="row">
                ...
                <div class="col-md-7 col-sm-8 col-sm-12">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-3 no-padding">
                        <a href="<?=Url::toRoute(['/store/order-step1']);?>" class="cart-button"><i class="fa fa-shopping-basket" aria-hidden="true"></i> <?=CartInformer::widget();?></a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <article class="item-list clearfix">
                                    <div class="col-md-4 col-sm-5 col-xs-6">
                                        <div class="img-wrapper">
                                            <a href="<?=Url::toRoute(['/store/item-card', 'id' => $product->id]);?>"> <img src="<?=$product->getImage()->getUrl();?>" alt="<?=$product->name;?>" class="img-responsive">
                                        </div>
                                    </div>
