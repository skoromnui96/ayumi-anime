                ...
                <div class="col-md-7 col-sm-8 col-sm-12">
                    <div class="col-md-4 col-sm-4 col-xs-4 no-padding">
                        <ul class="view btn-panel">
                            <li> <a href="<?=Url::toRoute(['store/card-view']);?>"  class="select"><i class="fa fa-th-large" aria-hidden="true"></i></a></li>
                            <li> <a href="<?=Url::toRoute(['store/list-view']);?>"><i class="fa fa-bars" aria-hidden="true"></i></a></li>
                        </ul>
                    </div>
                            ...
                            <div class="dropdown-wrapper">
                                ...
                                <div class="dropdown categories">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                        ...
                                        <li> <a href="<?=Url::toRoute(['store/card-view-desc']);?>"  class="select">Старые</a></li>
                                        <li> <a href="<?=Url::toRoute(['store/card-view']);?>"  class="select">Новые</a></li>
                        ...
                        <div class="filter">
                            <div class="cat-content">
                                <?php foreach($categories as $cat) { ?>
                                    ...
                                    <label for="s-<?=$cat->id?>" <?php if($cat->id == $category->id) echo 'class="line"';?>>
                                        <a href="<?=Url::toRoute(['/store/card-view', 'categoryId' => $cat->id]);?> "><?=$cat->name;?></a>
                                    </label>
                                <?php } ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-6">
                            <article class="item-card clearfix">
                                <div class="img-wrapper">
                                    <a href="<?=Url::toRoute(['/store/item-card', 'id' => $product->id]);?>"> <img src="<?=$product->getImage()->getUrl('300x300');?>" alt="<?=$product->name;?>" class="img-responsive"></a>
