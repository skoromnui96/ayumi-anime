...
$(document).ready(function(){$(".quick-search-open").click(function(){$(".search-wrapper").toggleClass("show")}),$(".quick-search-close").click(function(){$(".search-wrapper").toggleClass("show")}),$("nav .show-more").click(function(t){$(".more").toggleClass("show")}),$(".s-main-heading").slick({prevArrow:'<button type="button" class="slick-prev"><i class="fa fa-angle-left" aria-hidden="true"></i></button>',nextArrow:'<button type="button" class="slick-next"><i class="fa fa-angle-right" aria-hidden="true"></i></button>',arrows:!0,dots:!1,slidesToShow:1,slidesToScroll:1,infinite:!0}),$("ul.tabs-caption").on("click","li:not(.is-open)",function(){$(this).addClass("is-open").siblings().removeClass("is-open").closest("div").find("div.tabs-content").removeClass("is-open").eq($(this).index()).addClass("is-open")}),$("#next-tab").click(function(){$("#tabs-caption-item-1").removeClass("is-open"),$("#tabs-caption-item-2").addClass("is-open"),$("#tabs-content-item-1").removeClass("is-open"),$("#tabs-content-item-2").addClass("is-open")}),$(".top-rated .row").slick({prevArrow:'<button type="button" class="direction-btn-left">prev</button>',nextArrow:'<button type="button" class="direction-btn-rigt">next</button>',arrows:!0,dots:!1,slidesToShow:2,slidesToScroll:1,infinite:!0,responsive:[{breakpoint:768,settings:{arrows:!0,dots:!1,slidesToShow:1,slidesToScroll:1}}]}),$(".top-sales .row .shop").slick({prevArrow:'<button type="button" class="direction-btn-left">prev</button>',nextArrow:'<button type="button" class="direction-btn-rigt">next</button>',arrows:!0,dots:!1,slidesToShow:4,slidesToScroll:4,infinite:!0,responsive:[{breakpoint:992,settings:{arrows:!0,dots:!1,slidesToShow:2,slidesToScroll:2,infinite:!0}},{breakpoint:767,settings:{arrows:!0,dots:!1,slidesToShow:1,slidesToScroll:1,infinite:!0}}]}),$(".menu-open").click(function(){$(".main-navigation").stop().slideToggle(250)}),$(".filter label").click(function(){$(this).toggleClass("line")}),$(".single-item .image-wrapper").slick({arrows:!1,dots:!0,slidesToShow:1,slidesToScroll:1,infinite:!0}),$(".pagination li").click(function(t){$(".pagination li").removeClass("is-active"),$(this).addClass("is-active")}),$(".radio-wrapper label").click(function(t){$(".radio-wrapper label").removeClass("is-select"),$(this).addClass("is-select")}),$(".tariff").click(function(t){$(".tariff").removeClass("is-select"),$(this).addClass("is-select")}),function(t){t(window).on("load",function(){t(".s-ordering .order, .adult-modal .description-text").mCustomScrollbar({theme:"dark"})})}(jQuery),function(t){var i=function(t){function i(t){function i(){var i=parseInt(t[0].value);i--,(!e||i>=e)&&(t[0].value=i)}function l(){var i=parseInt(t[0].value);i++,(!o||i<=o)&&(t[0].value=i++)}t.attr("disabled")||(s.on("click",i),n.on("click",l))}var e=t.data("min")||!1,o=t.data("max")||!1,s=t.prev(".dec"),n=t.next(".inc");t.each(function(){i($(this))})};$(t).each(function(){i($(this))})}(".fieldCount"),$("#like").click(function(){$("#counter-like").html(+$("#counter-like").html()+1)}),$("#dislike").click(function(){$("#counter-dislike").html(+$("#counter-dislike").html()+1)}),$(".dropdown .dropdown-menu li").on("click",function(){var t=$(this).text();$(this).parent(".dropdown-menu").prev(".dropdown-toggle").html(t)})});