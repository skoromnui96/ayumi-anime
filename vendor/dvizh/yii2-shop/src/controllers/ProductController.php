...
class ProductController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        $searchModelAddons = new AddOnsSearch();
        $priceModel = new Price;
        ...
        $dataProviderAddons = $searchModelAddons->search(Yii::$app->request->queryParams);
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('update', [
                ...
                'searchModel' => $searchModel,
                'priceModel' => $priceModel,
                'dataProviderAddons' => $dataProviderAddons,
                'addonsModel' => $addonsModel,
                'searchModelAddons' => $searchModelAddons
            ]);
        }
    }
