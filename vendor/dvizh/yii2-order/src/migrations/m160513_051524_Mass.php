    ...
    public function safeUp()
    {
        ...
        try {
            $this->createTable('{{%order}}', [
                ...
                'gender' => Schema::TYPE_STRING . "(100) NOT NULL",
                'news_subscription' => Schema::TYPE_INTEGER . "(11)",
                'same_shipping' => Schema::TYPE_INTEGER . "(11)",
                'address1' => Schema::TYPE_STRING . "(255)",
                'address2' => Schema::TYPE_STRING . "(255)",
                'country' => Schema::TYPE_STRING . "(255)",
                'state' => Schema::TYPE_STRING . "(255)",
                'post_code' => Schema::TYPE_INTEGER . "(11)",
