...
class Order extends \yii\db\ActiveRecord implements OrderInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['status', 'date', 'payment', 'first_name', 'last_name', 'phone', 'email', 'comment', 'delivery_time_date', 'delivery_type', 'address'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => yii::t('order', 'ID'),
            'first_name' => yii::t('order', 'Client name'),
            'last_name' => yii::t('order', 'Client name'),
            'address' => yii::t('order', 'Address'),
            'address2' => yii::t('order', 'Address 2(optional)'),
            'country' => yii::t('order', 'Country'),
            'state' => yii::t('order', 'State'),
            'city' => yii::t('order', 'City'),
            'gender' => yii::t('order', 'Gender'),
            'postal_code' => yii::t('order', 'Postal code'),
            'same_address' => yii::t('order', 'Same shipping address'),
            'news_subscription' => yii::t('order', 'News subscription'),
    ...
    {
        return [
            'customer' => ['promocode', 'comment', 'first_name', 'last_name', 'gender','address','address2', 'country','state', 'city','postal_code','same_adress', 'news_subscription' ,'shipping_type_id', 'payment_type_id', 'phone', 'email', 'delivery_time_date', 'delivery_time_hour', 'delivery_time_min', 'delivery_type'],
