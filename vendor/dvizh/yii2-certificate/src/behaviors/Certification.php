<?php
namespace dvizh\certificate\behaviors;
        ...
        if (yii::$app->certificate->getCode()) {
            ...
            foreach ($orderElements as $orderElement) {
                foreach ($targetModelList as $targetModel) {
                    ...
                    if ($targetModel->target_model == $orderElement->getModel()->className() && $sourceTarget || $targetModel->target_model == 'dvizh\service\models\Category' && $sourceTarget) {
