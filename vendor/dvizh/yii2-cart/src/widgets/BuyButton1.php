...
class BuyButton1 extends \yii\base\Widget
{
    public $text = NULL;
    public $model = NULL;
    public $count = 1;
    public $price = false;
    public $description = '';
    public $cssClass = 'button bordered';
    public $htmlTag = 'a';
    public $options = null;
    public $addElementUrl = '/cart/element/create1';
    ...
    public function run()
    {
        ...
        return Html::tag($this->htmlTag, $this->text, [
            ...
            'class' => "dvizh-cart-buy-button{$this->model->getCartId()} {$this->cssClass}",
            'data-id' => $model->getCartId(),
            'data-url' => Url::toRoute([$this->addElementUrl, 'id' => $model->getCartId()]),
